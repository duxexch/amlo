...
(async () => {
  ...
  app.get("/api/metrics", async (_req, res) => {
    ...
    const lines = [
      ...
      `# HELP ablox_social_call_balance_warnings_emitted Total call balance warning events emitted to callers`,
      `# TYPE ablox_social_call_balance_warnings_emitted counter`,
      `ablox_social_call_balance_warnings_emitted ${socialStabilityMetrics.callBalanceWarningsEmitted}`,
      `# HELP ablox_social_call_balance_exhausted_ended Total calls force-ended due to exhausted balance`,
      `# TYPE ablox_social_call_balance_exhausted_ended counter`,
      `ablox_social_call_balance_exhausted_ended ${socialStabilityMetrics.callBalanceExhaustedEnded}`,
