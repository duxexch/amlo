...
const advancedSettings: Record<string, any> = {
  seo: {
    metaTitle: "Aplo — بث مباشر وهدايا",
    metaDescription: "أبلو — منصة البث المباشر العربية الأولى. شارك لحظاتك مع أصدقائك.",
    metaKeywords: "بث مباشر, هدايا افتراضية, دردشة, ترفيه, عرب",
    ogImage: "",
    canonicalUrl: "https://aplo.app",
    robotsTxt: "User-agent: *\nAllow: /\nSitemap: https://aplo.app/sitemap.xml",
    sitemapEnabled: true,
    googleAnalyticsId: "",
    googleSearchConsoleId: "",
  },
  aso: {
    appName: "Aplo - بث مباشر وهدايا",
    shortDescription: "بث مباشر وهدايا افتراضية",
    longDescription: "أبلو هي منصة البث المباشر العربية. شاهد بثوثاً مباشرة، أرسل هدايا، ودردش مع أصدقائك.",
    keywords: ["بث مباشر", "هدايا", "دردشة", "ترفيه", "تواصل اجتماعي"],
    category: "Social Networking",
    contentRating: "Teen",
    screenshots: [],
    promoVideo: "",
    supportUrl: "https://aplo.app/support",
    privacyUrl: "https://aplo.app/privacy",
  },
  socialLogin: {
  ...
  seoTexts: {
    homeTitle: "Aplo — بث مباشر وهدايا",
    homeDescription: "استمتعوا بأفضل تجربة بث مباشر عربية",
    aboutTitle: "عن أبلو",
    aboutDescription: "أبلو هي المنصة الأولى للبث المباشر في الوطن العربي",
  ...
  policies: {
    ...
    termsOfService: {
      ...
      content: "باستخدامك لتطبيق أبلو، فإنك توافق على الشروط والأحكام التالية...",
      lastUpdated: new Date().toISOString(),
    },
    communityGuidelines: {
